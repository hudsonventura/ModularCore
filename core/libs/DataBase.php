	...
	protected function connect(){
		try{
			...
			if(core::$coreConfig['databases'][$this->db]['vendor'] <> 'oci'){
				$this->conn = new \PDO(core::$coreConfig['databases'][$this->db]['vendor'].":dbname=".core::$coreConfig['databases'][$this->db]['dbname'].";host=".core::$coreConfig['databases'][$this->db]['host'].";port=".core::$coreConfig['databases'][$this->db]['port'], core::$coreConfig['databases'][$this->db]['user'], core::$coreConfig['databases'][$this->db]['pass']);
			}
