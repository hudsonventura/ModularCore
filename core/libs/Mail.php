...
class Mail extends PHPMailer {
	function __construct() {
		...
		$this->IsSMTP();
		$this->Host = core::$coreConfig['email_smtp_host'];
		$this->Port = core::$coreConfig['email_smtp_port'];
		
		if(core::$coreConfig['email_login']!= ''){

			$this->SMTPAuth = true;
			$this->Username = core::$coreConfig['email_login'];
			$this->Password = core::$coreConfig['email_pass'];
		}
		
		$this->From = core::$coreConfig['email_from_addr'];
		$this->FromName = core::$coreConfig['email_from_name'];
