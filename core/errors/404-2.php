...
<div class="content-container"> 
  <h3>Error 404 - The Function Requested is Not Found</h3> 
  <h4>The resource you are looking for has been removed, had its name changed, or is temporarily unavailable.</h4> 
</div> 

<div class="content-container"> 
 <fieldset><h4>Most likely causes:</h4> 
  <ul> 	<li>The function specified does not exist on the file.</li> 	<li>The URL contains a typographical error.</li> 	<li>A custom filter or module, such as URLScan, restricts access to the function.</li> </ul> 
 </fieldset> 
</div> 
